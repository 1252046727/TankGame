...
public partial class MsgHandler
{
    ...
    //回血协议
    public static void MsgAddHp(ClientState c, MsgBase msgBase)
    {
    ...
    //增加攻击协议
    public static void MsgAddAttack(ClientState c, MsgBase msgBase)
    {
        ...
        //广播
        msg.id = player.id;
        msg.AttackBonus = AttackBonus;
        room.Broadcast(msg);
    }

    //增加敏捷协议
    public static void MsgAddAgility(ClientState c, MsgBase msgBase)
    {
